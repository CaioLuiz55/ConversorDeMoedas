...
from PegarMoedas import nomes_moedas, conversoes_disponiveis
from PegarCotaçao import pegar_cotaçao_moeda
...
titulo = customtkinter.CTkLabel(janela, text='Conversor de Moedas', font=('arial 12', 30))
